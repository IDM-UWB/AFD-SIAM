...
%
%   Example
%   subidx = linidx2subidx([2 2],[1 2 3 4],true)
%
...
% Compute maximum admissible linear index
maxAdmissibleLinidx = prod(siz);
...
if checkRanges && (any(linidx<1) || any(linidx>maxAdmissibleLinidx)) % FIXME this check takes a lot of time
